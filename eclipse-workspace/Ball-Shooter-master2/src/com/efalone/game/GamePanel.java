		...
		for (int i = 0; i < bullets.size(); i++) {
			...
			for (int j = 0; j < enemies.size(); j++) {
				...
				if(coll.check(bx, by, bw, bh, ex, ey, ew, eh)) {
					...
					if (com.efalone.game.Enemy.r<=10) 
						player.score+=5;
						else if (com.efalone.game.Enemy.r>10 &&com.efalone.game.Enemy.r<=20)
							player.score+=4;
					    else if (com.efalone.game.Enemy.r>20 &&com.efalone.game.Enemy.r<=30)
					    	player.score+=3;
					    	else if (com.efalone.game.Enemy.r>30 &&com.efalone.game.Enemy.r<=40)
					    		player.score+=2;
					    		else if (com.efalone.game.Enemy.r>40 &&com.efalone.game.Enemy.r<=50)
					    			player.score+=1;
